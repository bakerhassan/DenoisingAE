...
if __name__ == "__main__":
    ...
    parser.add_argument("-tp", "--training_path", type=str, default='/lustre/cniel/ds003097-derivative/registered',
                        help="training path")
    parser.add_argument("-ep", "--evaluation_path", type=str, default='/lustre/cniel/ds003097-derivative/heldout/registered',
